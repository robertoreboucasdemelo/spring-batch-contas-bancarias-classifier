...
CREATE TYPE tipo_enum AS ENUM('PRATA','OURO','PLATINA','DIAMANTE');
...
INSERT INTO cliente (nome, idade, email, faixa_salarial) VALUES ('Maxie Reilly III', 62, 'garrison.larson@example.com', '634.82');
...
INSERT INTO cliente (nome, idade, email, faixa_salarial) VALUES ('Mr. Major Connell IV', 96, 'zmuller@example.org', '57016018.85');
